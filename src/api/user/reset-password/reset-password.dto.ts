...
export class UserResetPasswordResponseDto extends SuccessResponseDto {}

export class UserResetPasswordBadRequestResponseDto extends BadRequestResponseDto {
  /**
  ...
  @ApiProperty({
    ...
    enumName: 'UserResetPasswordBadRequestErrorMessageEnum',
