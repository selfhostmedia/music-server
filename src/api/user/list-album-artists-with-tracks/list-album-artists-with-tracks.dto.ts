...
export class UserListAlbumArtistsWithTracksQueryDto extends PaginationQueryDto {
  /**
...
export class UserListAlbumArtistsWithTracksResponseDto extends SuccessResponseDto {
  /**
...
const UserListArtistsWithTracksBadRequestErrorMessages = [
...
export class UserListAlbumArtistsWithTracksBadRequestResponseDto extends BadRequestResponseDto {
  /**
  ...
  @ApiProperty({
    isArray: true,
    enum: UserListArtistsWithTracksBadRequestErrorMessages,
    enumName: 'UserListArtistsWithTracksBadRequestErrorMessage',
    default: UserListArtistsWithTracksBadRequestErrorMessages[0],
  })
